kate.AddCommand( 'Mute', function( pl, target, time, reason )
...
kate.AddCommand( 'UnMute', function( pl, target )
  local steamId64 = kate.TargetToSteamID64( target )
  if steamId64 == nil then
    return
  end
...
kate.AddCommand( 'Gag', function( pl, target, time, reason )
  local steamId64 = kate.TargetToSteamID64( target )
  if steamId64 == nil then
    return
  end
...
kate.AddCommand( 'UnGag', function( pl, target )
  local steamId64 = kate.TargetToSteamID64( target )
  if steamId64 == nil then
    return
  end
