...
kate.AddCommand( 'Armor', function( pl, target, armor )
  armor = armor or 100
...
kate.AddCommand( 'God', function( pl, target )
...
kate.AddCommand( 'Cloak', function( pl, target )
  if ( not IsValid( pl ) ) and ( target == nil ) then
    return
  end
...
kate.AddCommand( 'Ammo', function( pl, target, count, ammo )
  if ( not IsValid( pl ) ) and ( target == nil ) then
    return
  end
