kate.AddCommand( 'Slay', function( pl, target )
  target:Kill()
...
kate.AddCommand( 'Model', function( pl, target, model )
...
kate.AddCommand( 'Size', function( pl, target, size )
...
kate.AddCommand( 'Freeze', function( pl, target )
...
kate.AddCommand( 'Ignite', function( pl, target, time )
...
kate.AddCommand( 'Strip', function( pl, target, swep )
  if swep ~= nil then
